...
st_date calculate_vacation_return_date(st_date date, short vacation_days)
{
...
int main()
{
    ...
    short vacation_days = read_vacation_days();

    cout << "\nReturn Date: ";
    date = calculate_vacation_return_date(date, vacation_days);
